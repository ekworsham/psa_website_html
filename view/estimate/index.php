...
<div class="container_12">
  ...
  <div class="grid_9" id="content_box">
    <div id="content">
      <h2>Free Monthly Maintenance Estimate</h2>
      <div class="contact-wrapper">
        <div class="contact-card">
          <?php if ($estimateStatus['success']): ?>
            <div class="alert success"><?php echo htmlspecialchars($estimateStatus['success'], ENT_QUOTES, 'UTF-8'); ?></div>
          <?php elseif ($estimateStatus['errors']): ?>
            <div class="alert error">
              <ul>
                <?php foreach ($estimateStatus['errors'] as $error): ?>
          ...
          <form name="contactform" method="post" action="index.php">
            ...
            <div class="form-group">
              <label for="estimate_name">Name <span class="optional">(Optional)</span></label>
              <input type="text" name="name" id="estimate_name" value="<?php echo htmlspecialchars($estimateData['name'], ENT_QUOTES, 'UTF-8'); ?>">
            </div>
            <div class="form-group">
              <label for="estimate_email">Email</label>
              <input type="email" name="email" id="estimate_email" required aria-required="true" value="<?php echo htmlspecialchars($estimateData['email'], ENT_QUOTES, 'UTF-8'); ?>">
            </div>
            <div class="form-group">
              <label for="estimate_address">Property Address <span class="optional">(Please include City, State, Zip Code)</span></label>
              <input type="text" name="address" id="estimate_address" required aria-required="true" value="<?php echo htmlspecialchars($estimateData['address'], ENT_QUOTES, 'UTF-8'); ?>">
            </div>
            <div class="form-actions">
              <input type="submit" name="submit" value="Get Free Estimate" id="estimate_submit">
              <br><br>
              <span class="highlight-text">Not Ready?</span> Learn more about <a href="/view/services/index.php">Monthly Service</a>
            </div>
          </form>
        </div>
      </div>
      <p class="highlight-text">Get a $50 credit towards a landscape enhancement when you accept our free estimate</p>
